    ...
    if (product.status === 'rejected')
      return (
        <div className={`${base} bg-red-50 text-red-700`}>
          Rejected: {product.rejectionReason || 'No reason provided'}
        </div>
      );
  ...
  return (
    <div className='max-w-3xl mx-auto p-4'>
      ...
      <div className='text-xs text-gray-600 dark:text-gray-300 mb-2'>
        Category: {product?.category_name || (product?.category as any) || 'N/A'}
      </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, batteryLife: e.target.value })}
              className='w-full border px-3 py-2 rounded'
            />
          </div>
          <div>
          ...
          <div className='sm:col-span-2'>
            ...
            <input
              value={form.batteryDescription}
              onChange={(e) => setForm({ ...form, batteryDescription: e.target.value })}
              className='w-full border px-3 py-2 rounded'
            />
          </div>
          <div className='sm:col-span-2'>
