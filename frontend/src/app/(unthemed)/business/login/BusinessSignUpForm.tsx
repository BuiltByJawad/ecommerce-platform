        ...
        <Form className='flex flex-col items-center justify-center relative'>
          ...
          <div className='mb-4 w-full'>
            ...
            <Field
              ...
              name='company_name'
              className={`w-full px-3 py-2 text-sm border rounded-lg ${
                errors.company_name && touched.company_name ? 'border-red-500' : 'border-gray-300'
              }`}
            />
            <ErrorMessage
              name='company_name'
          ...
          <div className='w-full grid grid-cols-2 gap-4 mb-4'>
            <div>
              <label htmlFor='tax_id' className='block text-sm font-medium text-gray-600'>
              ...
              <Field
                ...
                name='tax_id'
                className={`w-full px-3 py-2 text-sm border rounded-lg ${
                  errors.tax_id && touched.tax_id ? 'border-red-500' : 'border-gray-300'
                }`}
              />
          ...
          <div className='mb-4 w-full'>
            ...
            <Field
              ...
              name='business_type'
              className={`w-full px-3 py-2 text-sm border rounded-lg ${
                errors.business_type && touched.business_type ? 'border-red-500' : 'border-gray-300'
              }`}
            >
